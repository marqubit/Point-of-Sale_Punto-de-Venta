...
<div class="container-fluid">
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Punto de Venta MarQubit.Net</center></font>
<div id="mainmain">
	<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i><br> Ventas</a> 
	<?php //<a href="products.php"><i class="icon-list-alt icon-2x"></i><br> Productos</a> ?>     
	<a href="customer.php"><i class="icon-group icon-2x"></i><br> Clientes</a>     
	<?php // <a href="supplier.php"><i class="icon-group icon-2x"></i><br> Proveedores</a>  ?>     
	<?php // <a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i><br> Reporte de Ventas</a>?>  
