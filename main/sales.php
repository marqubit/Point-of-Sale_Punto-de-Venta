		...
		<table class="table table-bordered" id="resultTable" data-responsive="table">
			<thead>
				<tr>
					...
					<?php  // Esto es para que muestre la columna llamada ganancia si es admin o Vendedor si es cashier
					if($position== 'admin'){
				    ?>
					    <th> Ganancia </th>
					<?php
			...
			<tbody>
					...
					//impresion de ganancias o usuario porque el cajero no puede ver las ganancias
					if($position =='admin'){
						echo $profit;
					}
					else{
				...
				<tr>
					...
					<th colspan="1"><strong style="font-size: 12px; color: #222222;">
				<?php 
