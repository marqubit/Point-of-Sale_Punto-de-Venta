...
<div class="container">
  <div class="header"><a href="#"><img src="../img/qubit_logo.jpg" alt="Insertar logotipo aquí" name="Insert_logo" width="180" height="90" id="Insert_logo" style="background-color: #8090AB; display:block;" /></a> 
    <!-- end .header --></div>
  <div class="sidebar1">
    <ul class="nav">
		...
		<li><a href="donaciones.php" >Hacer Donativo</a></li>
		<li><a href="preguntar.php" >Hacer Pregunta Personal a MarQubit</a></li>
		<li><a href="consejos.php" >Pedir un Consejo a MarQubit</a></li>
		<li><a href="contenido.php" >Mas contenido</a></li>
		<li><a href="lluviaIdeas.php" >Lluvia de ideas</a></li>
		<li><a href="about.php" >Quien es MarQubit?</a></li>
    
    </ul>
    <p>&nbsp;</p>
    <!-- end .sidebar1 --></div>
  <div class="content"><!-- TemplateBeginEditable name="RContenido" -->
    <h1>Instrucciones</h1>
  ...
  <div class="footer">
    <p>MarQubit.Net, creado para practicar programación 13/05/2016</p>
  <!-- end .footer --></div>
  <!-- end .container --></div>
</body>
</html>
